<?php //Template Name: Deposit Opening?>
<?php acf_form_head(); ?>
<?php get_header(); 
?>
<style>
        ...
        if (isset($_GET['success']) && $_GET['success'] == 'true') {
            ...
            if ( have_posts() ) :
                ...
                //   $emailtoSend = get_field('email_address', $postID);
                    $applicationType = 'DEPOSIT'; // or 'APPRAISAL', 'WITHDRAWAL', etc. (make this dynamic)
                   ...
                   $emailContent = '
                        ...
                        <body>
                          <div class="container">
                            <div class="header">Website Deposit Application</div>
                            ...
                            <div class="footer">
                              *** This is an automatically generated email. Please do not reply. ***<br><br>
                              ...
                              corner Doña Hemady St., New Manila, Quezon City<br>
                              (02) 811-0278<br>
